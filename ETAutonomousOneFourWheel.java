...
/**
 * Created by megan on 11/5/2016.
 */
@Autonomous(name="ET Auto Four Wheel Drive by Gyro: Parking", group="ET Robot")
public class ETAutonomousOneFourWheel extends LinearOpMode{
    ...
    public void gyroDrive ( double speed,
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()&&
                ...
                robot.rightBackMotor.setPower(rightFrontSpeed);
                ...
                telemetry.addData("Actual", "%7d:%7d", robot.leftFrontMotor.getCurrentPosition(),
                        robot.rightFrontMotor.getCurrentPosition(), robot.leftBackMotor.getCurrentPosition(), robot.rightBackMotor);
